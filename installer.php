...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'NguyenQuocDat_205051629_DoAn_cdb4c196e2c3d8978018_20240111040820_archive.zip';
	const ARCHIVE_SIZE		 = '146576947';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'cdb4c19-11040820';
	const VERSION			 = '3.7.9';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v3.7.9==');
		self::log('----------------------------------------------------');
